...
public class RegrasDimensInfraEKS {
    public static void main(String[] args) {
        ...
        System.out.print("Digite o número total de pods: ");
        int numeroTotalPods = scan.nextInt();
        ...
        // Aplicando recomendações de Nodes
        ...
        // Aplicando recomendações de Servidores
